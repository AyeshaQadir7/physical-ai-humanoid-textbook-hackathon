# Assessment: Introduction to Physical AI and Humanoid Robotics
...
Create a new ROS 2 package called `module1_exercises` with a publisher node that:
...
- Name the file: `module1_assessment_yourname.zip`
...
- This textbook's Module 1 content
