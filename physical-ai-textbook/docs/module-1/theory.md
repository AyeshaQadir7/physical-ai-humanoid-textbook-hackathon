# Theory: Introduction to Physical AI and Humanoid Robotics
...
This module has introduced you to the fundamental concepts of Physical AI and humanoid robotics. You've learned about the historical context, advantages and challenges of humanoid design, and the essential tools (ROS 2 and Gazebo) that form the foundation of modern robotics development.
